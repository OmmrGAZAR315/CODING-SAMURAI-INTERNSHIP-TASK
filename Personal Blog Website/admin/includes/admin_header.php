...
if (isset($_SESSION["user_role"])) {
	...
	} elseif ($_SERVER["PHP_SELF"] != "/cms/admin/admin_posts.php" && $_SERVER["PHP_SELF"] != "/cms/admin/admin_comments.php" && $_SERVER["PHP_SELF"] != "/cms/admin/admin_profile.php" && $_SERVER["PHP_SELF"] != "/cms/admin/admin_user_data.php"&& $_SERVER["PHP_SELF"] != "/cms/admin/admin_users.php"&& $_SERVER["PHP_SELF"] != "/cms/admin/admin_categories.php") {
